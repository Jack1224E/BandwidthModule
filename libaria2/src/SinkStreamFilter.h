...
private:
  ...
  PieceBlockTracker* pieceBlockTracker_{nullptr};
  bool hashUpdate_;
  size_t bytesProcessed_;
  bool lastWriteCommitted_{false};
  cuid_t cuid_{0};

public:
  SinkStreamFilter(WrDiskCache* wrDiskCache = nullptr, bool hashUpdate = false,
                   PieceBlockTracker* pieceBlockTracker = nullptr);
  ...
  bool getLastWriteCommitted() const { return lastWriteCommitted_; }
